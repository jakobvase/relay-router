type PromiseType<T> = Promise<T | { default: T }>;
...
export class Resource<T> {
  _error: any;
  _loader: () => PromiseType<T>;
  _promise: PromiseType<T> | null;
  _result: T | null;

  constructor(loader: () => PromiseType<T>) {
    this._error = null;
    this._loader = loader;
    this._promise = null;
    this._result = null;
 ...
 */
export const JSResource = <T>(
  moduleId: String,
  loader: () => PromiseType<T>
): Resource<T> => {
